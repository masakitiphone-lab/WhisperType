...
export function getAuthFlowCopy(locale: AppLocale): AuthFlowCopy {
  if (locale === "ja") {
    return {
      ...
      pkceFailed: "ログイン確認に失敗しました。アプリを開いたままもう一度お試しください。",
  ...
  if (locale === "es") {
    return {
      preparing: "Preparando el inicio de sesion...",
      openingBrowser: "Abriendo Google en el navegador...",
      waitingForBrowser: "Completa el inicio de sesion en el navegador...",
      exchangingCode: "Finalizando el acceso...",
      signInComplete: "Inicio de sesion completado.",
      callbackMissingCode: "No se pudo confirmar el inicio de sesion. Intentalo de nuevo.",
      callbackFailed: "No se pudo confirmar el acceso desde el navegador. Intentalo de nuevo.",
      openBrowserFailed: "No se pudo iniciar el acceso con Google.",
      exchangeFailed: "No se pudo completar el inicio de sesion. Intentalo de nuevo.",
      pkceFailed: "No se pudo verificar el acceso. Deja la app abierta e intentalo de nuevo.",
      signOutFailed: "No se pudo cerrar la sesion. Intentalo de nuevo.",
    };
  }
