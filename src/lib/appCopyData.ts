...
const EN: Copy = {
  ...
  stateFinishedTitle: "Pasted",
  stateFinishedDescription: "Paste completed successfully.",
  badgeRecording: "Recording",
  badgeWorking: "Working",
  badgeDone: "Done",
  quickControls: "Quick controls",
  quickControlsDescription: "Keep everyday settings within easy reach.",
  appLanguage: "App language",
  appLanguageDescription: "Choose the interface language.",
  ...
  recordTranscribeInsert: "Record, transcribe, paste.",
  activeShortcut: "Active shortcut",
  homeStatusTitle: "Voice input is ready",
  homeStatusDescription: "Press your shortcut, speak naturally, and paste text into any app.",
  ...
  loginDescription: "WhisperType opens Google sign-in in your browser and returns to the desktop app.",
  ...
  settingsPromoDescription: "Use campaign or bonus codes here.",
  settingsPromoPlaceholder: "Enter promo code",
  settingsPromoClaim: "Claim credits",
  settingsPromoNote: "Enter a code to add credits to your account.",
  settingsPromptClear: "Clear prompt",
  settingsPromptJapanese: "Japanese preset",
  settingsPromptEnglish: "English preset",
  settingsPromptHint: "Keep this short. Use it for names, brand spelling, or mixed Japanese/English dictation.",
...
const JA: Copy = {
  ...
  shellDescription: "ショートカット、文字起こし言語、プラン、クレジットをまとめて管理できます。",
  ...
  voiceInput: "音声入力",
  stateIdleTitle: "準備完了",
  stateIdleDescription: "ショートカットを押して話し、離すと挿入します。",
  ...
  appLanguage: "アプリ言語",
  appLanguageDescription: "UI の言語を選択します。",
  ...
  shortcutCardDescription: "一度クリックし、設定したいショートカットを押して離すと保存されます。",
  quickSettingsTitle: "クイック設定",
  quickSettingsDescription: "メイン画面から言語とモデルをすばやく変更できます。",
  promoCardTitle: "プロモーションコード",
  promoCardDescription: "プロモーションコードを適用してクレジットを追加できます。",
  promoCardHint: "コードはプラン画面から入力できます。",
  shortcutRecorderTitle: "ショートカットを設定",
  continueWithGoogle: "Googleで続ける",
  loginHeadline: "一度サインインすれば、音声入力をすぐ使えます。",
  loginDescription: "WhisperType はブラウザで Google サインインを開き、デスクトップアプリに戻ります。",
  ...
  settingsHotkeyDescription: "音声入力を開始するキー操作を設定します。",
  settingsPromptTitle: "プロンプト",
  settingsPromptDescription: "名前、混在言語、文体などを補助するための詳細設定です。",
  settingsPromoTitle: "プロモーションコード",
  settingsPromoDescription: "キャンペーンや特典コードをここで受け取れます。",
  ...
  settingsPromptHint: "短く保ってください。名前、ブランド表記、日英混在の文字起こしに使えます。",
  ...
  settingsTier: "ティア",
  settingsPlannedNativeBackend: "ネイティブバックエンド",
  ...
  settingsStatus: "状態",
  settingsNativeRuntime: "ネイティブ実行状態",
  settingsNativePreflight: "事前確認",
